...
import { Settings as SettingsIcon, Send, Info } from "lucide-react";
...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="max-w-2xl">
      <PageHeader
        title="Settings"
        subtitle="Configure system-wide preferences for your workspace"
      />
      ...
      <div className="space-y-6">
            ...
            {[
              {
                ...
                desc: "Send booking reminders via WhatsApp",
              },
              {
                key: "smsEnabled" as const,
                label: "SMS notifications",
                desc: "Send booking reminders via SMS",
              },
              {
                key: "ivrEnabled" as const,
                label: "IVR Call alerts",
                desc: "Automated voice call reminders",
              },
            ].map((item) => (
        ...
        <Card className="p-5">
          ...
          <p className="text-xs text-muted mt-3">
            Language preference is saved locally. Backend integration will apply
            this to notifications.
          </p>
        </Card>
        ...
        <Card className="p-5">
          ...
          <p className="text-sm text-muted mb-4">
            Send a test WhatsApp message to verify your configuration. Currently
            a stub — backend WhatsApp API integration is pending.
          </p>
          ...
          <div className="mt-3 rounded-lg bg-info-bg px-4 py-3 flex gap-2">
            <Info className="h-4 w-4 text-info shrink-0 mt-0.5" aria-hidden="true" />
            <p className="text-xs text-info">
              Backend-managed settings (business hours, notification templates,
              buffer times) are configured by the backend team and will appear
              here once connected.
            </p>
          </div>
        </Card>
